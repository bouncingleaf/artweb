  ...
  return (
    <>
      ...
      <div className='card'>
        ...
        <p>
          As of this writing (April 2025), I have made more than 90 of these cards, so if you are holding one, you're holding at least 100 of a set of over 9000 circles. Not impressive yet, perhaps, but I'm not done.
        </p>
        <p>

...
const Resist = () => (
    <div>
        ...
        <h2>Reminders</h2>
        <p>Things I'm reminding myself:</p>
        <ul>
            <li>
                <b>Choose your battles.</b> Getting worked up about every new offense will wear you out fast. Ignore the noise, focus on what does real harm.
            </li>
            <li>
                <b>Limit news.</b> Take in news only to the extent that it helps you. Doomscrolling can feel like "doing something." It isn't.
            </li>
            <li>
                <b>We aren't powerless.</b> There ARE things people can do. There ARE people taking action.
            </li>
            <li>
                <b>Consider your strengths.</b> How can you be most effective? What do you have access to, what skills do you have, what resources do you have? (Hint: One of my skills is publishing a website, another is assembling information from disparate sources...)
            </li>
            <li>
        ...
        <div>
            ...
            <p>For a few weeks, I tried to keep track of the destruction being done to our country and the world, but I've only got so much energy and you can get your news elsewhere.</p>
            ...
            <p>Below, just a few notable events from the first few weeks of Term 2.</p>
            ...
            <h3>Wow.</h3>
            <p>
                Day four or so and I just gave up trying to stay on top of this list. Gotta admit the guy's getting a lot done. A lot of damage.

            </p>
            <p>
                I added a list of news links at the top of this page. Remember that keeping informed should serve a good purpose. Being motivated to act is a good purpose. Being stressed out to the point where you are too overwhelmed to act is not.
            </p>
